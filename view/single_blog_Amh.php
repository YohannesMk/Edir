            ...
            <div class="row">
                <div class="col-lg-9">
                    <article class="entry single-entry">
                        <div class="entry-body">
                            <div class="entry-meta">
                                ...
                                በ <a href="contact_Amh.php">እድር አስተዳዳር</a>
                                </span>
                    ...
                    <div class="related-posts">
                        <h3 class="title">ተዛማጅ ልጥፎች</h3><!-- End .title -->
                    ...
                    <div class="reply">
                        <div class="heading">
                            <h3 class="title">መልስ አስቀምጥ</h3><!-- End .title -->
                            <p class="title-desc"> የኢሜል አድራሻዎ አይታተምም። አስፈላጊ መስኮች ምልክት ተደርጎባቸዋል *</p>
                        </div><!-- End .heading -->

                        <form action="#">
                            <label for="reply-message" class="sr-only">አስተያየት</label>
                            <textarea name="reply-message" id="reply-message" cols="30" rows="4" class="form-control" required placeholder="አስተያየት *"></textarea>

                            <div class="row">
                                <div class="col-md-6">
                                    <label for="reply-name" class="sr-only">ስም</label>
                                    <input type="text" class="form-control" id="reply-name" name="reply-name" required placeholder="ስም *">
                                </div><!-- End .col-md-6 -->

                                <div class="col-md-6">
                                    <label for="reply-email" class="sr-only">ኢሜይል</label>
                                    <input type="email" class="form-control" id="reply-email" name="reply-email" required placeholder="ኢሜይል *">
                                </div><!-- End .col-md-6 -->
                            </div><!-- End .row -->

                            <button type="submit" class="btn btn-outline-primary-2">
                                <span>አስተያየት ለጥፍ</span>
                ...
                <aside class="col-lg-3">
                    <div class="sidebar">
                        <div class="widget widget-search">
                            ...
                            <form method="GET" action="timeline_Amh.php">
                        ...
                        <div class="widget widget-cats">
                            ...
                            <ul>
                                ...
                                <li><a href="timeline_Amh.php?category=wedding<?php if(!empty($search)){echo '&search='.$search;}?>">ጋብቻ<span><?= $wnum?></span></a></li>
                                <li><a href="timeline_Amh.php?category=graduation<?php if(!empty($search)){echo '&search='.$search;}?>">ምረቃ<span><?= $gnum?></span></a></li>
                                <li><a href="timeline_Amh.php?category=funeral<?php if(!empty($search)){echo '&search='.$search;}?>">ቀብር<span><?= $fnum?></span></a></li>
                            </ul>
                        </div><!-- End .widget -->
