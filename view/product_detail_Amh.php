    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col">
                            ...
                            <form method="POST">
                                <div class="product-details product-details-sidebar">
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <button type="submit" name="product-submit" class="btn-product btn-cart"><span>ወደ ግዢው ቅርጫት ጨምር</span></a>
                ...
                <h2 class="title text-center mt-4 mb-4">እርስዎም ሊወዱት ይችላሉ</h2><!-- End .title text-center -->
                <div class="row">
                <?php
                                ...
                                <div class="product product-7 shadow text-center">
                                    <figure class="product-media">
                                        ...
                                        <div class="product-action">
                                            <button type="submit" name="bottom-submit" class="btn-product btn-cart"><span>ወደ ግዢው ቅርጫት ጨምር</span></button>
                                        </div><!-- End .product-action -->
                                    </figure><!-- End .product-media -->

                                    <input type="hidden" name="bottom-item-id" value="<?=$rows['item_id']?>">
                                    <div class="product-body">
                                        <h3 class="product-title"><a href="product_Amh.php?cat=<?= $rows['itemName']?>"><?= $rows['itemName']?></a></h3><!-- End .product-title -->
                                        <p><?php 
