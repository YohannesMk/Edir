...
<body>
      ...
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="timeline.html" >የጊዜ መስመር</a></li>
            <li><a href="services.html">አገልግሎቶች</a></li>
            <li><a href="events.html">ክስተቶች</a></li>
            <li><a href="members.html">አባላት</a></li>
            <li><a href="contact.html">እውቂያ</a></li>

            <li id="login">
                <div class="box">
                  <a href="login.html">ግባ</a>
              </div>
            </li>
          </ul>
        </div>
  ...
  <form method="post"  enctype="multipart/form-data">
    <h1 class="header-text">ክስተት ይለጥፉ</h1>
    <div class="post-row">
      <div class="col-25">
        <label for="eventType">የክስተት አይነት</label>
      </div>
      <div class="col-75">
  ...
  <div class="post-row">
    ...
    <div class="post-row">
      <div class="col-25">
        <label for="subject">የክስተት መግለጫ</label>
      </div>
      <div class="col-75">
        <textarea name="description" required id="subject" name="subject" placeholder="የሆነ ነገር ይጻፍ.." style="height:200px"></textarea>
      </div>
    </div>
    <div class="post-row">
...
<section id="footer">
  <div class="footer container">
    <div class="brand">
      <h1><span>እ</span>ድር <span>ጣ</span>ቢያ</h1>
    </div>
