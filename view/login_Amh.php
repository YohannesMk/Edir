...
<html lang="en" dir="ltr">
  ...
  <body>
    <div align = "right">
    <p ><a class = "button" href="../admin/index.php" > እንደ አስተዳዳሪ ይግቡ</a> </p>
      ...
      <form class="login-form" action="" method="post">
        ...
        <div class="txtb">
          ...
          <span data-placeholder="ስልክ ቁጥር"></span>
        </div>

        <div class="txtb">
          <input type="password" name="password" >
          <span data-placeholder="መክፈቻ ቁልፉ"></span>
        </div>

        <input type="submit" name="submit"  class="logbtn" id="pssword-input" >

        <div class="bottom-text" style="font-size:16px">
        መክፈቻ ቁልፉን ረሳኽው?<a href="../libraries/mailtrial/forgot-password.php"> የይለፍ ቃል መለወጥ</a>
          <br>
          መለያ የለህም?<a href="../profile/register.php"> መክፈት</a>
        </div>
