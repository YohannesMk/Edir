...
<head>
    ...
    <!-- Custom CSS -->
    <link href="../resource/plugins/bower_components/chartist/dist/chartist.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="../resource/plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css" />
    <!-- Custom CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="editUser.php" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="timeline-table.php" aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Timeline Table</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edir Adminstrator</h4>
                    </div>
                    ...
                    <div class="col-lg-5 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb ms-auto">
                            <li><a class="btn btn-warning" href="../controller/export.php?export_id=<?=$export_id?>">Export Table</a></li>
                        </ol>
                        <a href="?logout" class="
                btn btn-danger
                d-none d-md-block
